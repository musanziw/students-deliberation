  ...
  return (
    <div className="flex flex-col gap-y-2">
      ...
      <input type={type} name={name} id={id} placeholder={placeholder} onChange={onChange} value={value}
             className={`text-gray-500 border focus:ring-2 ring-blue-200 ring-offset-1 h-9 p-2 focus:outline-none focus:sh focus:inset-1 placeholder:text-sm ${className}`}
